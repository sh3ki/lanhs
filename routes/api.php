...
Route::group(['prefix' => 'dashboard'], static function () {
    ...
    // NOTIFICATION ROUTES
    Route::get('notifications/count', [DashboardNotificationController::class, 'count'])->name('dashboard.notifications.count');
    Route::get('notifications/unread-tickets', [DashboardNotificationController::class, 'unreadTickets'])->name('dashboard.notifications.unread-tickets');
    Route::post('notifications/mark-read', [DashboardNotificationController::class, 'markRead'])->name('dashboard.notifications.mark-read');
    ...
    // NEW-COUNT ROUTES - Must be BEFORE apiResource to avoid wildcard collision
    Route::get('tickets/new-count', [DashboardTicketController::class, 'getNewTicketCount'])->name('dashboard.tickets.new-count-alias');
    Route::get('tickets-notif/new-count', [DashboardTicketController::class, 'getNewTicketCount'])->name('dashboard.tickets.new-count');
    Route::post('tickets-notif/mark-read', [DashboardTicketController::class, 'markTicketsAsRead'])->name('dashboard.tickets.mark-read');
    
    // OTHER SPECIFIC ROUTES - Must be before apiResource
    ...
    Route::apiResource('tickets', DashboardTicketController::class)->except(['update'])->names('dashboard.tickets');
