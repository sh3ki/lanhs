                        ...
                        <form @submit.prevent="editUser">
                            ...
                            <div class="bg-white md:grid md:grid-cols-3 md:gap-6 px-4 py-5 sm:p-6">
                                ...
                                <div class="mt-5 md:mt-0 md:col-span-2">
                                    ...
                                    <div v-if="$store.state.user && $store.state.user.effective_dashboard_access && $store.state.user.role_id !== 1" class="mt-6 grid grid-cols-3 gap-6">
                                        <div class="col-span-3">
                                            <label class="block text-sm font-medium leading-5 text-gray-700" for="skills">{{ $t('Skills / Specialty') }}</label>
                                            <div class="mt-1 relative rounded-md shadow-sm">
                                                <input id="skills" v-model="user.skills" :placeholder="$t('e.g. Networking, Hardware, Software')" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-6">
    ...
    methods: {
        getUser() {
            ...
            axios.get('api/auth/user').then(function (response) {
                ...
                self.user.skills = response.data.skills || null;
            }).catch(function () {
                self.loading.details = false;
            });
        },
        ...
        editUser() {
            ...
            if (self.user.skills !== null) {
                formData.append('skills', self.user.skills || '');
            }
