<template>
    <div class="relative flex-1">
        ...
        <h1 class="py-0.5 text-2xl font-semibold text-gray-900 flex items-center gap-3">
            <div class="notification-container">
                <i class="fas fa-ticket-alt notification-icon" 
                   :class="{ 'has-notifications': newTicketCount > 0 }"></i>
    ...
    <div class="mt-4 flex md:mt-0 md:ml-4">
        <router-link
            class="btn btn-blue shadow-sm rounded-md mr-4 inline-flex items-center"
            to="/dashboard/tickets/new"
            @click="markTicketsAsRead"
        >
                                                    ...
                                                    <div class="absolute inset-0 px-4 sm:px-6">
                                                        <div class="grid grid-cols-3 py-3">
                                                            ...
                                                            <div class="col-span-3 mb-2">
                                                                ...
                                                                <div class="space-y-2">
                                                                    <div v-for="agent in agentList" :key="agent.id" class="flex items-center space-x-3">
                                                                        <input
                                                                            type="checkbox"
                                                                            :value="agent.id"
                                                                            v-model="filters.agents"
                                                                        ...
                                                                        />
                                                                        <img
                                                                            :src="agent.avatar !== 'gravatar' ? agent.avatar : agent.gravatar"
                                                                            alt="Icon"
                                                                            class="w-5 h-5 rounded-full"
                                                                        />
                                                                        <span :class="filters.agents.includes(agent.id) ? 'font-semibold' : 'font-normal'" class="text-sm">
                                                                            {{ agent.name }}
                                                                        </span>
                                                                    </div>
                                                                    <!-- Optional summary of selected count -->
                                                                    <div v-if="filters.agents.length > 0" class="text-sm text-gray-600 mt-1">
                                                                        {{ $t('Selected') }} {{ filters.agents.length }} {{ $t('options') }}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-span-3 mb-2">
                                                                ...
                                                                <div class="space-y-2">
                                                                    <div v-for="dept in departmentList" :key="dept.id" class="flex items-center space-x-3">
                                                                        <input
                                                                            type="checkbox"
                                                                            :value="dept.id"
                                                                            v-model="filters.departments"
                                                                            class="form-checkbox h-4 w-4 text-indigo-600 transition duration-150 ease-in-out"
                                                                        />
                                                                        <span :class="filters.departments.includes(dept.id) ? 'font-semibold' : 'font-normal'" class="text-sm">
                                                                            {{ dept.name }}
                                                                        </span>
                                                                    </div>
                                                                    <!-- Optional summary of selected count -->
                                                                    <div v-if="filters.departments.length > 0" class="text-sm text-gray-600 mt-1">
                                                                        {{ $t('Selected') }} {{ filters.departments.length }} {{ $t('options') }}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-span-3 mb-2">
                                                                ...
                                                                <div class="space-y-2">
                                                                    <div v-for="label in labelList" :key="label.id" class="flex items-center space-x-3">
                                                                        <input
                                                                            type="checkbox"
                                                                            :value="label.id"
                                                                            v-model="filters.labels"
                                                                        ...
                                                                        <svg-vue
                                                                            ...
                                                                            class="h-5 w-5"
                                                                            icon="font-awesome.circle-solid"
                                                                        ></svg-vue>
                                                                        <span :class="filters.labels.includes(label.id) ? 'font-semibold' : 'font-normal'" class="text-sm">
                                                                            {{ label.name }}
                                                                        </span>
                                                                    </div>
                                                                    <!-- Optional summary of selected count -->
                                                                    <div v-if="filters.labels.length > 0" class="text-sm text-gray-600 mt-1">
                                                                        {{ $t('Selected') }} {{ filters.labels.length }} {{ $t('options') }}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-span-3 mb-2">
                                                                ...
                                                                <div class="space-y-2">
                                                                    <div v-for="status in statusList" :key="status.id" class="flex items-center space-x-3">
                                                                        <input
                                                                            type="checkbox"
                                                                            :value="status.id"
                                                                            v-model="filters.statuses"
                                                                            class="form-checkbox h-4 w-4 text-indigo-600 transition duration-150 ease-in-out"
                                                                        />
                                                                        <span :class="filters.statuses.includes(status.id) ? 'font-semibold' : 'font-normal'" class="text-sm">
                                                                            {{ status.name }}
                                                                        </span>
                                                                    </div>
                                                                    <!-- Optional summary of selected count -->
                                                                    <div v-if="filters.statuses.length > 0" class="text-sm text-gray-600 mt-1">
                                                                        {{ $t('Selected') }} {{ filters.statuses.length }} {{ $t('options') }}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-span-3 mb-2">
                                                                <label class="block text-sm font-medium leading-5 text-gray-700" for="priority">
                                                                    {{ $t('Priorities') }}
                                                                </label>
                                                                <div class="space-y-2">
                                                                    <div v-for="priority in priorityList" :key="priority.id" class="flex items-center space-x-3">
                                                                        <input
                                                                            type="checkbox"
                                                                            :value="priority.id"
                                                                            v-model="filters.priorities"
                                                                            class="form-checkbox h-4 w-4 text-indigo-600 transition duration-150 ease-in-out"
                                                                        />
                                                                        <span :class="filters.priorities.includes(priority.id) ? 'font-semibold' : 'font-normal'" class="text-sm">
                                                                            {{ priority.name }}
                                                                        </span>
                                                                    </div>
                                                                    <!-- Optional summary of selected count -->
                                                                    <div v-if="filters.priorities.length > 0" class="text-sm text-gray-600 mt-1">
                                                                        {{ $t('Selected') }} {{ filters.priorities.length }} {{ $t('options') }}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-span-3 mb-2 flex justify-center" @click="changeSort" @change="changeSort">
                                                            <button @click.stop="getTickets"
                            ...
                            <template v-for="ticket in ticketList">
                                ...
                                >
                                    ...
                                    <td class="px-3 py-4 whitespace-no-wrap leading-5">
                                        ...
                                        <div class="text-sm leading-5 text-gray-500">
                                            <span v-if="ticket.priority" :class="priorityColor(ticket.priority.name)" class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium leading-4">
                                                {{ ticket.priority.name }}
                                            </span>
                                            <span v-else class="text-gray-400">{{ $t('Unassigned') }}</span>
                                        </div>
                                    </td>
                                    <td class="px-3 py-4 whitespace-no-wrap leading-5">
                                        <div class="text-sm leading-5 text-gray-900">
