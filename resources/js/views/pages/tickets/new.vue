                        ...
                        <div class="bg-white md:grid md:grid-cols-3 px-4 py-5">
                            <div class="md:col-span-2">
                                <div class="grid grid-cols-3 gap-6">
                                    ...
                                    <div v-if="priorityList.length > 0" class="col-span-3">
                                        <label class="block text-sm font-medium leading-5 text-gray-700" for="priority">{{ $t('Priority') }}</label>
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <select id="priority" v-model="ticket.priority_id" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5">
    ...
    methods: {
        ...
        uploadFile(e) {
            ...
            axios.post(
                ...
                self.ticket.attachments.push(attachment);
            }).catch(function () {
                self.loading.file = false;
                self.uploadingFileProgress = 0;
                self.$refs.fileInput.value = null;
