...
class TicketController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        // Technicians (dashboard access, non-admin) see tickets assigned to them as agent
        // Admin and regular users see tickets they submitted
        if ($user->checkEffectiveDashboardAccess() && $user->role_id !== 1) {
    ...
    {
        $userId = Auth::id();
        if ($ticket->user_id !== $userId && $ticket->agent_id !== $userId) {
